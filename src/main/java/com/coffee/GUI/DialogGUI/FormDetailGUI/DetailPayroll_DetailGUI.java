...
//                    Allowance allowance = new BonusBLL().searchBonuss("id = " + roleDetailBonus.getBonus_id()).get(0);
//                    BigDecimal bonus_amount = BigDecimal.valueOf(0);
//
//                    JLabel labelBonusName = new JLabel(allowance.getName());
//                    labelBonusName.setPreferredSize(new Dimension(1000, 30));
//                    labelBonusName.setFont((new Font("Public Sans", Font.PLAIN, 14)));
//
////                    if (allowance.getBonus_type() == 0) {
...
////                        }
////                        bonus_amount = BigDecimal.valueOf(dates.size() * allowance.getBonus_amount());
////
////                    } else if (allowance.getBonus_type() == 1) {
////                        bonus_amount = BigDecimal.valueOf(allowance.getBonus_amount());
////                    }
//
