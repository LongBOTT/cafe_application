...
public class DetailDiscountGUI extends DialogFormDetail_1 {
    ...
    public DetailDiscountGUI(Discount discount) {
        super();
        super.setTitle("Thông chương trình giảm giá");
    ...
    public void init(Discount discount) {
        ...
        txtProgramName.setFocusable(false);
        txtProgramName.setText(discount.getName());

        JTextField txtStatus = new MyTextFieldUnderLine();
        ...
        panelStatus.setLayout(new MigLayout("", "[]30[]", "15[]"));
